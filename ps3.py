...
def get_word_score(word, n):
    ...
    score1 = 0
    score2 = max(7*word_len - 3*(n-word_len), 1)
    
    for key in word_dict:
        score1 += word_dict[key] * SCRABBLE_LETTER_VALUES[key]
...
def update_hand(hand, word):
    ...
    returns: dictionary (string -> int)
    """
    temp_hand = copy.deepcopy(hand)  # Don't want to mutate hand 
    
    for letter in word.lower():
        temp_hand[letter] = temp_hand.get(letter,0) - 1    

    new_hand = copy.deepcopy(temp_hand)
...
def is_valid_word(word, hand, word_list):
    ...
    if star_pos != -1:
        for letter in VOWELS:
            if lower_word[0:star_pos] + letter + lower_word[star_pos+1:] in word_list:
                word_dict = get_frequency_dict(lower_word)
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    total_score = 0
    n = calculate_handlen(hand) # n is number of letters in hand #Returns false if dictionary is empty
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    game_score = 0
    turns = 1
    rounds = input("How many hands do you want to play: ")
    
    while type(rounds) != int:
        rounds = input("Sorry that input was invalid. How many hands do you want to play: ")
    ...
    while turns <= rounds:
        ...
        choice = raw_input("Would you like to substitute a letter? ")
        
        #Sub out letter if they choose yes
        if choice == "yes":
        ...
        while play == "yes":
            ...
            #ask if they want to replay hand
            play = raw_input("Would you like to replay the hand: ")
            
        game_score += round_score
        turns += 1
            
        print "Total score over all hands: " + str(game_score) + " points"    
